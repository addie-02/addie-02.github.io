...
<div class="project-entry">
  ...
  <img src="{{ site.baseurl }}/images/projects/bee_abm_animation_orchard.gif" alt="Bee ABM simulation output" style="max-width:50%; border-radius: 8px;">
...
<div class="project-entry">
  ...
  <img src="{{ site.baseurl }}/images/projects/derby_predictions-21.pdf" alt="FDA electricity demand forecast" style="max-width:50%; border-radius: 8px;">
...
<div class="project-entry">
  ...
  <img src="{{ site.baseurl }}/images/projects/at-model-plot.png" alt="Adaptive therapy model dynamics" style="max-width:50%; border-radius: 8px;">
